...
const ProductItem = ({ id, image, name, price, index }) => {
    ...
    return !loading ? (
        <div className='shadow-sm rounded-md relative'>
            ...
            <div className='flex items-center justify-between mx-auto px-2 lg:px-3 pb-3'>
                <button onClick={() => handleAddToCart()} className='font-semibold text-sm bg-pink px-1.5 py-1 sm:px-4 rounded sm:py-2 bg-gra'>
